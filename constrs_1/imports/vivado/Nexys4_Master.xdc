...
#set_property PACKAGE_PIN U9 [get_ports {buy_one}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {buy_one}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
#set_property PACKAGE_PIN U8 [get_ports {buy_two}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {buy_two}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports {coin_one}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {coin_one}]
...
set_property PACKAGE_PIN R3 [get_ports {get_ind}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {get_ind}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
set_property PACKAGE_PIN P3 [get_ports {cancle_flag}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cancle_flag}]
...
set_property PACKAGE_PIN T8 [get_ports {light_one}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {light_one}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {light_two}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {light_two}]
...
set_property PACKAGE_PIN V1 [get_ports {not_enough}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {not_enough}]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
set_property PACKAGE_PIN R1 [get_ports {op_start}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {op_start}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
set_property PACKAGE_PIN P5 [get_ports {hold_ind}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hold_ind}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
set_property PACKAGE_PIN U1 [get_ports {light_get}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {light_get}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {led[14]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {led[14]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {light}]					
...
set_property PACKAGE_PIN F15 [get_ports buy_two]						
	set_property IOSTANDARD LVCMOS33 [get_ports buy_two]
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
set_property PACKAGE_PIN T16 [get_ports coin_one]						
	set_property IOSTANDARD LVCMOS33 [get_ports coin_one]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports coin_ten]						
	set_property IOSTANDARD LVCMOS33 [get_ports coin_ten]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
set_property PACKAGE_PIN V10 [get_ports buy_one]						
	set_property IOSTANDARD LVCMOS33 [get_ports buy_one]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets coin_ten]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets coin_one]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets buy_one]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets buy_two]
